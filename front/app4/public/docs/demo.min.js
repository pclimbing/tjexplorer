...
var Demo = function() {
    ...
    Block = function(a) {
        this.elem = a;
        this.data = function() {
            var op ={title:{text:'每日平均区块高度'},legend:{data:['bar'],align:'left'},color:['#3398DB'],tooltip:{trigger:'axis',axisPointer:{type:'line'}},tooltip:{},xAxis:{data:[]},yAxis:{},series:[{name:'日期',type:'bar',data:[]}]}
            return op
        };
        this.render = function() {
            $("#" + this.elem).height(400);

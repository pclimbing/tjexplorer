...
var Demo = function() {
    ...
    Basic = function(a) {
        ...
        this.render = function() {
            ...
            $.get("http://10.15.190.85:10010/trans_last_hour",function(data,status){
                console.log(data)
    ...
    Block = function(a) {
        ...
        this.render = function() {
            ...
            chart.setOption(this.data())
                ...
                $.get("http://10.15.190.85:10010/daily_blocks_height",function(data,status){
                    var a = data.split('|')
                    var categories = []
                    var seriesdata = []
    ...
    Details = function(a, b) {
        ...
        this.render = function() {
            ...
            $.get("http://10.15.190.85:10010/blocks", function(datab, status) {
            ...
            $.get("http://10.15.190.85:10010/transactions", function(datat, status) {
